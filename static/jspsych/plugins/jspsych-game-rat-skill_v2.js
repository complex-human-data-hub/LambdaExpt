 ...
 * Example plugin template
    ver.2 counts time from the instroduction page
 */

jsPsych.plugins["game-rat-skill_v2"] = (function() {
    ...
    plugin.trial = function(display_element, trial) {
        ...
        function show_welcome(){
            ...
            p.innerHTML = "<h3>Card Game</h3>Great! Let's play the same card memory game as before. You will be presented with cards one at a time. There are " + MAX_RULES + " card sequences that will earn you points, these are listed below with their point value. Read the instruction below carefully, because you will lose points if you press the incorrect keys. ";
